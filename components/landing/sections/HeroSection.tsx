        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div variants={itemAnimation} className="text-center lg:text-left">
            ...
            <p className="text-lg sm:text-xl text-slate-600 mb-8 max-w-2xl leading-relaxed">
              <strong>Importa un PDF</strong> del lavoro per il <strong>tuo cliente</strong> ottieni: il <strong>preventivo</strong> da offrirgli, <strong>piano d'azione, tasks e budget.</strong> Mantieni il controllo di tutte le <strong>tue attività</strong> in un <strong>unico posto</strong> dove tutto avviene in maniera <strong>automatica!</strong><br /><br /> Dimentica <strong>calcoli manuali</strong> e <strong>perdite di tempo</strong>: concentrati su ciò che ami fare, al resto pensiamo noi.
            </p>
